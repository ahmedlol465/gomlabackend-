...
class DemoData {
  ...
  static final offers = [
    ...
    {'id': 'o16', 'productId': 'p12', 'productName': 'لبن جهينة - 1 لتر', 'category': 'ألبان', 'brand': 'جهينة', 'unitName': 'علبة', 'bulkUnit': 'شرينك (12)', 'bulkQty': 12, 'bulkPrice': 555, 'piecePrice': 53.19, 'tiers': demoTiers, 'unitPrice': 46.25, 'sellingFast': true, 'shortage': true, 'source': 'direct', 'wholesalerName': 'بابا عبدو', 'wholesalerId': 'ws0', 'stock': 25},
  ];
}
